...
final.plot + scale_color_discrete(name = "Clase",labels = clases) + theme(legend.text = ggtext::element_markdown())
```
...
```{r}
final.plot + labs(subtitle = "Consumo en **carretera**") + theme(plot.subtitle = ggtext::element_markdown())
```

...
![Calidad de gráficos en artículos científicos (xkcd)](https://imgs.xkcd.com/comics/scientific_paper_graph_quality.png){#fig-calidad}
...
![Gráfico "por defecto" en `Statistica`](){#fig-statistica}
...
![Rueda de Cairo](){#fig-rueda-cairo}
...
![Rueda preferida por científicos e ingenieros](){#fig-rueda-ciencia}

Mientras que los artistas, diseñadores gráficos y periodistas preferirían una esta otra:

![Rueda preferida por diseñadores gráficos](){#fig-rueda-arte}
...
![Gráfico de Minard sobre la invasión Napoleónica a Rusia](){fig-minard}
...
![Gráfico aparentemente inofensivo (Calorías por 100g de alimento)](){#fig-100g_orig}
...
![¿Realmente es necesario el color de fondo?](){#fig-100g-nobg}
...
![¿Calorías por 100 g de qué?](#fig-100g-nolegend)
...
![¿Más o menos calorías que el tocino?](#fig-100g-nocol)
...
![Un look más minimalista](#fig-100g-noshade)
...
![¿Cuántas calorías tienes?](){#fig-100g-naked}
...
![Precios monstruosas](){#fig-monsterprices}
...
![A que no me alcanzas](#fig-eleclies)
...
![Tú y yo no somos tan diferentes](#fig-electrue)

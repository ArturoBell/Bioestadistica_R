...
![Probabilidades marginales y condicionales](){#fig-probcond}
...
![Estadísticos, probabilidades y distribuciones (Fuente: xkcd)](){#fig-probstats}
...
Hasta este momento la sesión ha sido casi completamente teórica, y la razón es simple: aunque la probabilidad vista desde el punto de vista geométrico es "sencilla", en el momento en el que queremos llevarla a la realidad las cosas pueden volverse un poco caóticas, así que tomemos algunos ejemplos  